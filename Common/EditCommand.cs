...
namespace TaskTip.Common
{
    public static class EditCommand
    {
        ...
        /// 打印命令
        /// </summary>
        public static RoutedUICommand Print { get { return _Print; } }
        ...
        /// 插入附件命令
        /// </summary>
        //public static RoutedUICommand InsertAttachment { get { return _insertAttachment; } }

        /// <summary>
        /// 删除线命令
        /// </summary>
        public static RoutedUICommand StrikethroughText { get { return _strikethroughText; } }
        /// <summary>
        /// 插入图像命令
        /// </summary>
        ...
        /// 插入分页符命令
        /// </summary>
        public static RoutedUICommand InsertHorizontalLine { get { return _InsertHorizontalLine; } }
        /// <summary>
        /// 导出为文本文件
        /// </summary>
        public static RoutedUICommand ExportTxt { get { return _ExportTxt; } }
        ...
        static RoutedUICommand _Print = new RoutedUICommand();
        ...
        static RoutedUICommand _strikethroughText = new RoutedUICommand();
        //static RoutedUICommand _insertAttachment = new RoutedUICommand();
        static RoutedUICommand _InsertHorizontalLine = new RoutedUICommand();
        static RoutedUICommand _ExportTxt = new RoutedUICommand();
